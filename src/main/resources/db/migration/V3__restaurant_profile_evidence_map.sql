...
ALTER TABLE discovered_prospects ADD COLUMN latitude DOUBLE PRECISION NOT NULL DEFAULT 0;
ALTER TABLE discovered_prospects ADD COLUMN longitude DOUBLE PRECISION NOT NULL DEFAULT 0;
ALTER TABLE discovered_prospects ADD COLUMN base_score INTEGER NOT NULL DEFAULT 0;
