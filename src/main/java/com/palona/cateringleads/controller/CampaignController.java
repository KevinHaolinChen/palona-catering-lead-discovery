...
public class CampaignController {
    ...
    public CampaignController(CampaignService campaignService, DiscoveredProspectRepository prospectRepository) {
    ...
    public List<CampaignResponse> campaigns() { return campaignService.findAll(); }
    ...
    public DiscoveryRunResponse run(@PathVariable String runId) { return campaignService.findRun(runId); }
